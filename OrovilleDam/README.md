...
[SQL queries](https://github.com/axibase/atsd/blob/master/docs/api/sql/README.md#overview), which can be used to search for specific information contained in this dataset.
